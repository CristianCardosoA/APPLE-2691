...
//  Gato2
//
//  Created by David Israel Tsutsumi Bernal on 20/03/24.
//
...
class ViewController: UIViewController {
    ...
    @objc func tapImg1(_ sender: UITapGestureRecognizer){
        img1.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg2(_ sender: UITapGestureRecognizer){
        img2.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg3(_ sender: UITapGestureRecognizer){
        img3.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg4(_ sender: UITapGestureRecognizer){
        img4.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg5(_ sender: UITapGestureRecognizer){
        img5.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg6(_ sender: UITapGestureRecognizer){
        img6.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg7(_ sender: UITapGestureRecognizer){
        img7.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg8(_ sender: UITapGestureRecognizer){
        img8.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
    @objc func tapImg9(_ sender: UITapGestureRecognizer){
        img9.image = esCara ? UIImage(named: "cara") :UIImage(named: "aguila")
        esCara.toggle()
    }
}
